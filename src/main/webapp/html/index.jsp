...
<link href="<%=baseUrl%>/js/bootstrap-3.0.3/css/carousel.css"
	rel="stylesheet">
<script src="<%=baseUrl%>/js/bootstrap-3.0.3/docs-assets/js/holder.js"></script>
</head>
<!-- NAVBAR
================================================== -->
<body>
	...
	<div id="myCarousel" class="carousel slide" data-ride="carousel">
		...
		<div class="carousel-inner">
			...
			<div class="item">
				<img src="<%=baseUrl%>/images/test.jpg"
					alt="four slide">
				<div class="container">
					<div class="carousel-caption">
						<h1>One more for good measure.</h1>
